...
<?php foreach($types as $type) {?>
	<?php echo '<tr><th scope="row"><label for="data[Route][fuel]['.$type->id.']">'.$type->name.' (Litres of Fuel)</label></th><td><input id="data[Route][fuel]['.$type->id.']" name="data[Route][fuel]['.$type->id.']" type="text" value="'.$type->value.'"></td></tr>'?>
<?php }?>
